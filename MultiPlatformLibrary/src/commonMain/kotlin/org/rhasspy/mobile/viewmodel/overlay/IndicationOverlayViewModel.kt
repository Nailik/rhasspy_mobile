...
class IndicationOverlayViewModel : ViewModel(), KoinComponent {
    ...
    val indicationState
        get() = getSafe<IndicationService>()?.indicationState ?: MutableStateFlow(IndicationState.Idle).readOnly

    val isShowVisualIndication
        get() = getSafe<IndicationService>()?.isShowVisualIndication ?: MutableStateFlow(false).readOnly
