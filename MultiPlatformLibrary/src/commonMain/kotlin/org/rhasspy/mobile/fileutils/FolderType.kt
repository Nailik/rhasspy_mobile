...
sealed class FolderType(protected val folderName: String, val fileTypes: Array<String>) {
    ...
    sealed class SoundFolder(private val subfolder: String) : FolderType("sounds", arrayOf("audio/x-wav")) {
    ...
    sealed class CertificateFolder(private val subfolder: String): FolderType("certificates", arrayOf("application/x-java-keystore", "application/octet-stream")) {
    ...
    object PorcupineFolder: FolderType("porcupine", arrayOf("application/octet-stream", "application/zip"))
