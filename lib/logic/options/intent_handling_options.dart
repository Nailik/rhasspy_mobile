...
class IntentHandlingOptions extends Option<IntentHandlingOption> {
  static final IntentHandlingOptions _singleton = IntentHandlingOptions._internal();

  factory IntentHandlingOptions() {
    return _singleton;
  }

  IntentHandlingOptions._internal() : super(IntentHandlingOption.values, IntentHandlingOption.disabled);
