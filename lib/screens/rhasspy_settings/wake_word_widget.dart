...
Widget wakeWord() {
  ...
  return Obx(() => listItem(WakeWordOptions(), wakeWordOption,
      getLocale().wakeWord, localWakeWordSettings(wakeWordOption.value)));
}
...
Widget localWakeWordKeyword() {
  ...
  return Row(
    ...
    children: [
      ...
      ElevatedButton(onPressed: () {}, child: Text(getLocale().refresh))
    ],
  );
}
  ...
  return Obx(() => Column(children: <Widget>[
        Padding(
            ...
            child: Align(
                ...
                child: Text(
                    "${getLocale().sensitivity} (${wakeWordSensitivity.value.toString()})"))),
        SliderTheme(
          data: SliderThemeData(
              inactiveTrackColor: getTheme().colorScheme.secondary,
              trackHeight: 0.1,
