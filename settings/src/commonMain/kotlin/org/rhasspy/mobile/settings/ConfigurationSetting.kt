...
object ConfigurationSetting {
    ...
    val wakeWordPorcupineAudioRecorderSettings = ISetting(SettingsEnum.WakeWordPorcupineAudioRecorderSettings, false)
    ...
    val intentHandlingHomeAssistantAccessToken = ISetting(SettingsEnum.IntentHandlingHassAccessToken, "")
