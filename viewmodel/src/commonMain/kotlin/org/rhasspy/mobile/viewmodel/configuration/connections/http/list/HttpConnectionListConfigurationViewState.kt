...
data class HttpConnectionListConfigurationViewState internal constructor(
    val items: ImmutableList<HttpConfigurationItemViewState> = ConfigurationSetting.httpConnections.value.map { HttpConfigurationItemViewState(it) }.toImmutableList()
) {
